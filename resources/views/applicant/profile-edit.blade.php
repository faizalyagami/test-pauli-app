                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="full_name"
                                    ...
                                    value="{{ old('full_name', $applicant->full_name ?? $user->name) }}" required>
                                @error('full_name')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="gender" class="form-select @error('gender') is-invalid @enderror">
                                    ...
                                    <option value="male"
                                        {{ old('gender', $applicant->gender ?? '') == 'male' ? 'selected' : '' }}>Male
                                    </option>
                                    <option value="female"
                                        {{ old('gender', $applicant->gender ?? '') == 'female' ? 'selected' : '' }}>Female
                                    </option>
                                </select>
                                @error('gender')
                                    <div class="invalid-feedback">{{ $message }}</div>
