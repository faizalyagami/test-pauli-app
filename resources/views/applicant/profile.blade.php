        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body text-center">
                    <div class="mb-3">
                        @if ($user->avatar)
                            <img src="{{ Storage::url($user->avatar) }}" class="rounded-circle" width="150" height="150"
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <table class="table table-sm">
                        ...
                        <tr>
                            <th>Last Login</th>
                            <td>{{ $user->last_login_at ? \Carbon\Carbon::parse($user->last_login_at)->format('d F Y H:i') : '-' }}
                            </td>
                        </tr>
                        <tr>
                            <th>Status</th>
