                ...
                <div class="card-body py-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0 opacity-75">Welcome back, {{ Auth::user()->name }}! Here's what's happening with your tests today.</p>
                        </div>
                        <div>
                        ...
                        <table class="table table-hover mb-0 align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3">
                                        <span class="badge bg-info px-2 py-1 rounded-pill">{{ $session->test->test_code }}</span>
                                    </td>
                                    <td class="px-3 text-center">
                                        @if($session->score)
                                        <span class="badge bg-success px-2 py-1 rounded-pill">{{ number_format($session->score) }}</span>
                                        @else
                                    ...
                                    <td class="px-3 text-center">
                                        @php
                                        $statusColors = ['scheduled' => 'secondary', 'in_progress' => 'warning', 'completed' => 'success', 'evaluated' => 'info'];
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('tester.applicants') }}" class="btn btn-sm btn-link text-primary">View All</a>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="px-3">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">{{ $applicant->participant_numb }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-3">
                                    ...
                                    <td class="px-3 text-center">
                                        @php
                                        $statusColors = ['registered' => 'secondary', 'test_taken' => 'info', 'processed' => 'warning', 'accepted' => 'success', 'rejected' => 'danger'];
                                    ...
                                    <td class="px-3 text-center">
                                        <a href="{{ route('tester.applicants.show', $applicant) }}" class="btn btn-sm btn-outline-info">
